 ...
 * moved the exception controller to be a service (`twig.controller.exception:showAction` vs `Symfony2\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction`)
