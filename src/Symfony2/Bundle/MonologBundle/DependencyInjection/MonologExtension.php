...
class MonologExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if (isset($config['handlers'])) {
            ...
            $this->addClassesToCompile(array(
                ...
                'Monolog\\Logger',
                'Symfony2\\Bridge\\Monolog\\Logger',
                'Symfony2\\Bridge\\Monolog\\Handler\\DebugHandler',
    ...
    private function buildHandler(ContainerBuilder $container, $name, array $handler)
    {
        ...
        case 'console':
            if (!class_exists('Symfony2\Bridge\Monolog\Handler\ConsoleHandler')) {
        ...
        case 'swift_mailer':
            ...
            if (isset($handler['email_prototype'])) {
                ...
                $messageFactory = new Definition('Symfony2\Bundle\MonologBundle\SwiftMailer\MessageFactory');
