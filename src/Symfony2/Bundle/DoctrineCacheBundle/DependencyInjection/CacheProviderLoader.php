<?php
namespace Symfony2\Bundle\DoctrineCacheBundle\DependencyInjection;
...
class CacheProviderLoader
{
     ...
     * @param array                                                     $config
     *
     * @return \Symfony2\Component\DependencyInjection\DefinitionDecorator
     */
    protected function getProviderDecorator(ContainerBuilder $container, array $config)
    {
        ...
        if (null === $childDefinition) {
            $childDefinition = class_exists('Symfony2\Component\DependencyInjection\ChildDefinition') ? 'Symfony2\Component\DependencyInjection\ChildDefinition' : 'Symfony2\Component\DependencyInjection\DefinitionDecorator';
        }
     ...
     * @param \Symfony2\Component\DependencyInjection\ContainerBuilder   $container
     *
     * @return \Symfony2\Bundle\DoctrineCacheBundle\DependencyInjection\Definition\CacheDefinition
     */
