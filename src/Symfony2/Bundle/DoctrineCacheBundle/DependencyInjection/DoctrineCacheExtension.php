...
{
    /**
     * @var \Symfony2\Bundle\DoctrineCacheBundle\DependencyInjection\CacheProviderLoader
     */
    private $loader;

    /**
     * @param \Symfony2\Bundle\DoctrineCacheBundle\DependencyInjection\CacheProviderLoader $loader
     */
    ...
    protected function loadAcl(array $rootConfig, ContainerBuilder $container)
    {
        ...
        if ( ! interface_exists('Symfony2\Component\Security\Acl\Model\AclInterface')) {
