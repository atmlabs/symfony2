...
namespace Symfony2\Bundle\DoctrineCacheBundle\Acl\Model;
...
class AclCache implements AclCacheInterface
{
    ...
    /**
     * @var \Symfony2\Component\Security\Acl\Model\PermissionGrantingStrategyInterface
     */
     ...
     * @param \Symfony2\Component\Security\Acl\Model\PermissionGrantingStrategyInterface $permissionGrantingStrategy
     */
     ...
     *
     * @return \Symfony2\Component\Security\Acl\Model\AclInterface
     */
     ...
     *
     * @param \Symfony2\Component\Security\Acl\Model\ObjectIdentityInterface $oid
     *
     * @return string
     */
     ...
     * @param string $key
     *
     * @return null|\Symfony2\Component\Security\Acl\Model\AclInterface
     */
