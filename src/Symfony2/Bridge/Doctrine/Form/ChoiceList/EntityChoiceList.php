...
namespace Symfony2\Bridge\Doctrine\Form\ChoiceList;

@trigger_error('The '.__NAMESPACE__.'\EntityChoiceList class is deprecated since Symfony 2.7 and will be removed in 3.0. use Symfony2\Bridge\Doctrine\Form\ChoiceList\DoctrineChoiceLoader instead.', E_USER_DEPRECATED);

use Doctrine\Common\Persistence\Mapping\ClassMetadata;
use Doctrine\Common\Persistence\ObjectManager;
use Symfony2\Component\Form\Exception\RuntimeException;
use Symfony2\Component\Form\Exception\StringCastException;
use Symfony2\Component\Form\Extension\Core\ChoiceList\ObjectChoiceList;
