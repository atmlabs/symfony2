...
class DoctrineOrmTypeGuesser implements FormTypeGuesserInterface
{
    ...
    public function guessType($class, $property)
    {
        ...
        if ($metadata->hasAssociation($property)) {
            ...
            return new TypeGuess('Symfony2\Bridge\Doctrine\Form\Type\EntityType', array('em' => $name, 'class' => $mapping['targetEntity'], 'multiple' => $multiple), Guess::HIGH_CONFIDENCE);
        }
        ...
        switch ($metadata->getTypeOfField($property)) {
            ...
            case Type::BOOLEAN:
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\CheckboxType', array(), Guess::HIGH_CONFIDENCE);
            case Type::DATETIME:
            case Type::DATETIMETZ:
            case 'vardatetime':
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\DateTimeType', array(), Guess::HIGH_CONFIDENCE);
            case Type::DATE:
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\DateType', array(), Guess::HIGH_CONFIDENCE);
            case Type::TIME:
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\TimeType', array(), Guess::HIGH_CONFIDENCE);
            case Type::DECIMAL:
            case Type::FLOAT:
            ...
            case Type::TEXT:
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\TextareaType', array(), Guess::MEDIUM_CONFIDENCE);
            default:
                return new TypeGuess('Symfony2\Component\Form\Extension\Core\Type\TextType', array(), Guess::LOW_CONFIDENCE);
        }
    }
