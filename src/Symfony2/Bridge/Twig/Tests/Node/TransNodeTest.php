...
use Symfony2\Bridge\Twig\Node\TransNode;
use Twig\Compiler;
...
class TransNodeTest extends TestCase
{
    public function testCompileStrict()
    {
        ...
        $this->assertEquals(
            sprintf(
                'echo $this->env->getExtension(\'Symfony2\Bridge\Twig\Extension\TranslationExtension\')->getTranslator()->trans("trans %%var%%", array_merge(array("%%var%%" => %s), %s), "messages");',
