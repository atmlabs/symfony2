...
use Symfony2\Component\Translation\Loader\ArrayLoader;
use Symfony2\Component\Translation\MessageSelector;
use Symfony2\Component\Translation\Translator;
...
class TranslationExtensionTest extends TestCase
{
    ...
    public function getTransTests()
    {
        return array(
            ...
            array('{% trans with { \'%name%\': \'Symfony2\' } %}Hello %name%{% endtrans %}', 'Hello Symfony'),
            array('{% set vars = { \'%name%\': \'Symfony2\' } %}{% trans with vars %}Hello %name%{% endtrans %}', 'Hello Symfony'),
            ...
            array('{{ hello|trans({ \'%name%\': \'Symfony2\' }) }}', 'Hello Symfony', array('hello' => 'Hello %name%')),
            array('{% set vars = { \'%name%\': \'Symfony2\' } %}{{ hello|trans(vars) }}', 'Hello Symfony', array('hello' => 'Hello %name%')),
            ...
            array('{{ text|transchoice(5, {\'%name%\': \'Symfony2\'}) }}', 'There is 5 apples (Symfony)', array('text' => '{0} There is no apples|{1} There is one apple|]1,Inf] There is %count% apples (%name%)')),
