...
namespace Symfony2\Bridge\Twig\Translation;

use Symfony2\Component\Finder\Finder;
use Symfony2\Component\Finder\SplFileInfo;
use Symfony2\Component\Translation\Extractor\AbstractFileExtractor;
use Symfony2\Component\Translation\Extractor\ExtractorInterface;
...
class TwigExtractor extends AbstractFileExtractor implements ExtractorInterface
{
    ...
    {
        $visitor = $this->twig->getExtension('Symfony2\Bridge\Twig\Extension\TranslationExtension')->getTranslationNodeVisitor();
        $visitor->enable();
