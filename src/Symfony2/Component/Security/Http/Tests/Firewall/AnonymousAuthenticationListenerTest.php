...
use Symfony2\Component\Security\Http\Firewall\AnonymousAuthenticationListener;
...
class AnonymousAuthenticationListenerTest extends TestCase
{
    public function testHandleWithTokenStorageHavingAToken()
    {
        ...
        $listener->handle($this->getMockBuilder('Symfony2\Component\HttpKernel\Event\GetResponseEvent')->disableOriginalConstructor()->getMock());
    }
