...
use Symfony2\Component\Security\Http\Event\InteractiveLoginEvent;
use Symfony2\Component\Security\Http\Firewall\SimplePreAuthenticationListener;
...
class SimplePreAuthenticationListenerTest extends TestCase
{
    ...
    public function testHandle()
    {
        ...
        $simpleAuthenticator = $this->getMockBuilder('Symfony2\Component\Security\Http\Authentication\SimplePreAuthenticatorInterface')->getMock();
        $simpleAuthenticator
            ->expects($this->once())
            ->method('createToken')
    ...
    protected function setUp()
    {
        ...
        $this->event = $this->getMockBuilder('Symfony2\Component\HttpKernel\Event\GetResponseEvent')->disableOriginalConstructor()->getMock();
        $this->event
            ->expects($this->any())
            ->method('getRequest')
