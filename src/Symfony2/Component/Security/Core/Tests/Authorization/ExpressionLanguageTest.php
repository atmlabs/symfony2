...
use Symfony2\Component\Security\Core\Authentication\Token\RememberMeToken;
...
class ExpressionLanguageTest extends TestCase
{
    ...
    {
        $anonymousTokenClass = 'Symfony2\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken';
        $rememberMeTokenClass = 'Symfony2\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken';
