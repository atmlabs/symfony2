...
namespace Symfony2\Component\Security\Core\Tests\Authentication\RememberMe;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\Security\Core\Authentication\RememberMe\InMemoryTokenProvider;
...
class InMemoryTokenProviderTest extends TestCase
{
    ...
    /**
     * @expectedException \Symfony2\Component\Security\Core\Exception\TokenNotFoundException
     */
