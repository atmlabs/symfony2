...
namespace Symfony2\Component\Security\Core\Util;

use Symfony2\Component\Security\Acl\Util\ClassUtils as AclClassUtils;

@trigger_error('The '.__NAMESPACE__.'\ClassUtils class is deprecated since Symfony 2.8, to be removed in 3.0. use Symfony2\Component\Security\Acl\Util\ClassUtils instead.', E_USER_DEPRECATED);
