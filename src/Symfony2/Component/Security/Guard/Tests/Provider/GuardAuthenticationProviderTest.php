...
namespace Symfony2\Component\Security\Guard\Tests\Provider;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\Security\Guard\Provider\GuardAuthenticationProvider;
use Symfony2\Component\Security\Guard\Token\PostAuthenticationGuardToken;
use Symfony2\Component\Security\Guard\Token\PreAuthenticationGuardToken;
...
class GuardAuthenticationProviderTest extends TestCase
{
    ...
    public function testAuthenticate()
    {
        ...
        $authenticatorA = $this->getMockBuilder('Symfony2\Component\Security\Guard\GuardAuthenticatorInterface')->getMock();
        $authenticatorB = $this->getMockBuilder('Symfony2\Component\Security\Guard\GuardAuthenticatorInterface')->getMock();
        $authenticatorC = $this->getMockBuilder('Symfony2\Component\Security\Guard\GuardAuthenticatorInterface')->getMock();
        ...
        $mockedUser = $this->getMockBuilder('Symfony2\Component\Security\Core\User\UserInterface')->getMock();
        ...
        $authedToken = $this->getMockBuilder('Symfony2\Component\Security\Core\Authentication\Token\TokenInterface')->getMock();
        $authenticatorB->expects($this->once())
    ...
    public function testCheckCredentialsReturningNonTrueFailsAuthentication()
    {
        ...
        $authenticator = $this->getMockBuilder('Symfony2\Component\Security\Guard\GuardAuthenticatorInterface')->getMock();
    ...
    /**
     * @expectedException \Symfony2\Component\Security\Core\Exception\AuthenticationExpiredException
     */
    ...
    {
        $this->userProvider = $this->getMockBuilder('Symfony2\Component\Security\Core\User\UserProviderInterface')->getMock();
        $this->userChecker = $this->getMockBuilder('Symfony2\Component\Security\Core\User\UserCheckerInterface')->getMock();
        $this->preAuthenticationToken = $this->getMockBuilder('Symfony2\Component\Security\Guard\Token\PreAuthenticationGuardToken')
