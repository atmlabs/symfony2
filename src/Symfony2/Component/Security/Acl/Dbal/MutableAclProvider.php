...
namespace Symfony2\Component\Security\Acl\Dbal;
...
use Symfony2\Component\Security\Acl\Exception\AclAlreadyExistsException;
...
use Symfony2\Component\Security\Acl\Model\MutableAclInterface;
use Symfony2\Component\Security\Acl\Model\MutableAclProviderInterface;
    ...
    public function updateAcl(MutableAclInterface $acl)
    {
        ...
        try {
            ...
            if (count($sharedPropertyChanges) > 0) {
                $classAcesProperty = new \ReflectionProperty('Symfony2\Component\Security\Acl\Domain\Acl', 'classAces');
                $classAcesProperty->setAccessible(true);
                $classFieldAcesProperty = new \ReflectionProperty('Symfony2\Component\Security\Acl\Domain\Acl', 'classFieldAces');
        ...
        foreach ($changes[1] as $field => $new) {
            for ($i = 0, $c = count($new); $i < $c; ++$i) {
                ...
                if (null === $ace->getId()) {
                    ...
                    $aceIdProperty = new \ReflectionProperty('Symfony2\Component\Security\Acl\Domain\Entry', 'id');
