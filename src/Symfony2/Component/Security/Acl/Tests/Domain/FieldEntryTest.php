...
use Symfony2\Component\Security\Acl\Domain\FieldEntry;
...
class FieldEntryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSerializeUnserialize()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Security\Acl\Model\SecurityIdentityInterface', $uAce->getSecurityIdentity());
    ...
    {
        return $this->getMock('Symfony2\Component\Security\Acl\Model\AclInterface');
    }

    protected function getSid()
    {
        return $this->getMock('Symfony2\Component\Security\Acl\Model\SecurityIdentityInterface');
    }
}
