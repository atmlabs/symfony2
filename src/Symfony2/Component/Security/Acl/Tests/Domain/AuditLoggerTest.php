...
class AuditLoggerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMock('Symfony2\Component\Security\Acl\Model\AuditableEntryInterface');
    }

    protected function getLogger()
    {
        return $this->getMockForAbstractClass('Symfony2\Component\Security\Acl\Domain\AuditLogger');
    }
}
