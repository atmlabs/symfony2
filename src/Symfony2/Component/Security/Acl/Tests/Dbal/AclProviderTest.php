...
class AclProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \Symfony2\Component\Security\Acl\Exception\AclNotFoundException
    ...
    public function testFindAclsThrowsExceptionUnlessAnACLIsFoundForEveryOID()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symfony2\Component\Security\Acl\Exception\AclNotFoundException', $e);
            $this->assertInstanceOf('Symfony2\Component\Security\Acl\Exception\NotAllAclsFoundException', $e);
    ...
    public function testFindAcls()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Security\Acl\Domain\Acl', $acl0 = $acls->offsetGet($oids[0]));
        $this->assertInstanceOf('Symfony2\Component\Security\Acl\Domain\Acl', $acl1 = $acls->offsetGet($oids[1]));
    ...
    public function testFindAcl()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Security\Acl\Domain\Entry', $aces[0]);
        ...
        $this->assertInstanceOf('Symfony2\Component\Security\Acl\Domain\UserSecurityIdentity', $sid);
