...
namespace Symfony2\Component\Security\Csrf;
...
use Symfony2\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface;
use Symfony2\Component\Security\Csrf\TokenGenerator\UriSafeTokenGenerator;
use Symfony2\Component\Security\Csrf\TokenStorage\NativeSessionTokenStorage;
use Symfony2\Component\Security\Csrf\TokenStorage\TokenStorageInterface;
