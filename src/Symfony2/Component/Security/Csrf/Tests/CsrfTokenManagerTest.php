...
class CsrfTokenManagerTest extends TestCase
{
    ...
    public function testGetNonExistingToken($namespace, $manager, $storage, $generator)
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Security\Csrf\CsrfToken', $token);
    ...
    {
        $generator = $this->getMockBuilder('Symfony2\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface')->getMock();
        $storage = $this->getMockBuilder('Symfony2\Component\Security\Csrf\TokenStorage\TokenStorageInterface')->getMock();
    ...
    {
        return array(
            $this->getMockBuilder('Symfony2\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface')->getMock(),
            $this->getMockBuilder('Symfony2\Component\Security\Csrf\TokenStorage\TokenStorageInterface')->getMock(),
        );
    }
