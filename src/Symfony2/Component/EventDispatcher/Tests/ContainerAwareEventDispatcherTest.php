...
namespace Symfony2\Component\EventDispatcher\Tests;

use Symfony2\Component\DependencyInjection\Container;
use Symfony2\Component\DependencyInjection\Scope;
use Symfony2\Component\EventDispatcher\ContainerAwareEventDispatcher;
...
class ContainerAwareEventDispatcherTest extends AbstractEventDispatcherTest
{
    ...
    public function testAddAListenerService()
    {
        ...
        $service = $this->getMockBuilder('Symfony2\Component\EventDispatcher\Tests\Service')->getMock();
    ...
    public function testAddASubscriberService()
    {
        ...
        $service = $this->getMockBuilder('Symfony2\Component\EventDispatcher\Tests\SubscriberService')->getMock();
        ...
        $dispatcher = new ContainerAwareEventDispatcher($container);
        $dispatcher->addSubscriberService('service.subscriber', 'Symfony2\Component\EventDispatcher\Tests\SubscriberService');
    ...
    public function testReEnteringAScope()
    {
        ...
        $service1 = $this->getMockBuilder('Symfony2\Component\EventDispatcher\Tests\Service')->getMock();
        ...
        $service2 = $this->getMockBuilder('Symfony2\Component\EventDispatcher\Tests\Service')->getMock();
