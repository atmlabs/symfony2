...
namespace Symfony2\Component\Serializer\Normalizer;

use Symfony2\Component\Serializer\Exception\CircularReferenceException;
use Symfony2\Component\Serializer\Exception\InvalidArgumentException;
use Symfony2\Component\Serializer\Exception\LogicException;
use Symfony2\Component\Serializer\Exception\RuntimeException;
use Symfony2\Component\Serializer\Mapping\AttributeMetadataInterface;
use Symfony2\Component\Serializer\Mapping\Factory\ClassMetadataFactoryInterface;
use Symfony2\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter;
use Symfony2\Component\Serializer\NameConverter\NameConverterInterface;
...
abstract class AbstractNormalizer extends SerializerAwareNormalizer implements NormalizerInterface, DenormalizerInterface
{
     ...
     *
     * @deprecated Deprecated since version 2.7, to be removed in 3.0. use Symfony2\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter instead.
     *
    ...
    {
        @trigger_error(sprintf('The "%s()" method is deprecated since Symfony 2.7 and will be removed in 3.0. use Symfony2\Component\Serializer\NameConverter\CamelCaseToSnakeCaseNameConverter instead.', __METHOD__), E_USER_DEPRECATED);
