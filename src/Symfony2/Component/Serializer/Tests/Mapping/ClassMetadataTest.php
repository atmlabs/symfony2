...
class ClassMetadataTest extends TestCase
{
    public function testInterface()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Serializer\Mapping\ClassMetadataInterface', $classMetadata);
    }
    ...
    public function testAttributeMetadata()
    {
        ...
        $a1 = $this->getMockBuilder('Symfony2\Component\Serializer\Mapping\AttributeMetadataInterface')->getMock();
        $a1->method('getName')->willReturn('a1');

        $a2 = $this->getMockBuilder('Symfony2\Component\Serializer\Mapping\AttributeMetadataInterface')->getMock();
    ...
    public function testMerge()
    {
        ...
        $ac1 = $this->getMockBuilder('Symfony2\Component\Serializer\Mapping\AttributeMetadataInterface')->getMock();
        $ac1->method('getName')->willReturn('a1');
        $ac1->method('getGroups')->willReturn(array('a', 'b'));

        $ac2 = $this->getMockBuilder('Symfony2\Component\Serializer\Mapping\AttributeMetadataInterface')->getMock();
