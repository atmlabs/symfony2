...
use Symfony2\Component\Serializer\Tests\Fixtures\GroupDummy;
use Symfony2\Component\Serializer\Tests\Fixtures\PropertyCircularReferenceDummy;
use Symfony2\Component\Serializer\Tests\Fixtures\PropertySiblingHolder;
...
class PropertyNormalizerTest extends TestCase
{
    ...
    {
        $this->serializer = $this->getMockBuilder('Symfony2\Component\Serializer\SerializerInterface')->getMock();
    ...
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(
            ...
            ), 'Symfony2\Component\Serializer\Tests\Fixtures\GroupDummy', null, array(PropertyNormalizer::GROUPS => array('name_converter')))
        );
    }
    ...
    public function testCircularReferenceHandler()
    {
        ...
        $expected = array('me' => 'Symfony2\Component\Serializer\Tests\Fixtures\PropertyCircularReferenceDummy');
