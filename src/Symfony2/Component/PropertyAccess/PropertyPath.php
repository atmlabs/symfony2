...
namespace Symfony2\Component\PropertyAccess;

use Symfony2\Component\PropertyAccess\Exception\InvalidArgumentException;
use Symfony2\Component\PropertyAccess\Exception\InvalidPropertyPathException;
use Symfony2\Component\PropertyAccess\Exception\OutOfBoundsException;
...
class PropertyPath implements \IteratorAggregate, PropertyPathInterface
{
    ...
    public function __construct($propertyPath)
    {
        ...
        if (!\is_string($propertyPath)) {
            throw new InvalidArgumentException(sprintf('The property path constructor needs a string or an instance of "Symfony2\Component\PropertyAccess\PropertyPath". Got: "%s"', \is_object($propertyPath) ? \get_class($propertyPath) : \gettype($propertyPath)));
        }
