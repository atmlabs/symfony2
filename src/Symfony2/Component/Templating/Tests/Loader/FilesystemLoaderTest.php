...
class FilesystemLoaderTest extends TestCase
{
    ...
    public function testLoad()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Templating\Storage\FileStorage', $storage, '->load() returns a FileStorage if you pass an absolute path');
        ...
        $this->assertInstanceOf('Symfony2\Component\Templating\Storage\FileStorage', $storage, '->load() returns a FileStorage if you pass a relative template that exists');
