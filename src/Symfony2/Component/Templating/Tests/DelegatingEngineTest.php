...
use Symfony2\Component\Templating\DelegatingEngine;
use Symfony2\Component\Templating\EngineInterface;
use Symfony2\Component\Templating\StreamingEngineInterface;
...
class DelegatingEngineTest extends TestCase
{
    ...
    {
        $engine = $this->getMockForAbstractClass('Symfony2\Component\Templating\Tests\MyStreamingEngine');
