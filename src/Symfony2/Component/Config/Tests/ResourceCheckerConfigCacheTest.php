...
namespace Symfony2\Component\Config\Tests;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\Config\Resource\FileResource;
use Symfony2\Component\Config\ResourceCheckerConfigCache;
use Symfony2\Component\Config\Tests\Resource\ResourceStub;
...
class ResourceCheckerConfigCacheTest extends TestCase
{
    ...
    {
        $checker = $this->getMockBuilder('\Symfony2\Component\Config\ResourceCheckerInterface')->getMock()
