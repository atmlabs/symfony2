...
namespace Symfony2\Component\Config\Definition\Dumper;

use Symfony2\Component\Config\Definition\ArrayNode;
use Symfony2\Component\Config\Definition\ConfigurationInterface;
use Symfony2\Component\Config\Definition\EnumNode;
use Symfony2\Component\Config\Definition\NodeInterface;
use Symfony2\Component\Config\Definition\PrototypedArrayNode;
                ...
                if ($prototype instanceof ArrayNode) {
                    ...
                    if ($prototype->hasDefaultValue()) {
                        ...
                        switch (\get_class($prototype)) {
                            case 'Symfony2\Component\Config\Definition\ScalarNode':
                                $prototypeValue = 'scalar value';
                                break;

                            case 'Symfony2\Component\Config\Definition\FloatNode':
                            case 'Symfony2\Component\Config\Definition\IntegerNode':
                                $prototypeValue = 'numeric value';
                                break;

                            case 'Symfony2\Component\Config\Definition\BooleanNode':
                                $prototypeValue = 'true|false';
                                break;

                            case 'Symfony2\Component\Config\Definition\EnumNode':
