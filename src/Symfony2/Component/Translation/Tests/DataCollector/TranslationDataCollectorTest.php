...
namespace Symfony2\Component\Translation\Tests\DataCollector;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\Translation\DataCollector\TranslationDataCollector;
use Symfony2\Component\Translation\DataCollectorTranslator;

class TranslationDataCollectorTest extends TestCase
{
    protected function setUp()
    {
        if (!class_exists('Symfony2\Component\HttpKernel\DataCollector\DataCollector')) {
    ...
    {
        $translator = $this
            ->getMockBuilder('Symfony2\Component\Translation\DataCollectorTranslator')
