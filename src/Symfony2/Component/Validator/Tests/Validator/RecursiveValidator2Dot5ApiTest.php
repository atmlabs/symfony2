...
class RecursiveValidator2Dot5ApiTest extends Abstract2Dot5ApiTest
{
    ...
    public function testEmptyGroupsArrayDoesNotTriggerDeprecation()
    {
        ...
        $validatorContext = $this->getMockBuilder('Symfony2\Component\Validator\Validator\ContextualValidatorInterface')->getMock();
        $validatorContext
            ->expects($this->once())
            ->method('validate')
        ...
        $validator = $this
            ->getMockBuilder('Symfony2\Component\Validator\Validator\RecursiveValidator')
