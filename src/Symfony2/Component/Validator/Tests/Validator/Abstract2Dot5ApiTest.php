...
use Symfony2\Component\Validator\Constraints\Expression;
...
use Symfony2\Component\Validator\Tests\Fixtures\FailingConstraint;
use Symfony2\Component\Validator\Tests\Fixtures\FakeClassMetadata;
use Symfony2\Component\Validator\Tests\Fixtures\Reference;
...
abstract class Abstract2Dot5ApiTest extends AbstractValidatorTest
{
    ...
    /**
     * @expectedException \Symfony2\Component\Validator\Exception\UnsupportedMetadataException
     * @group legacy
     */
    public function testMetadataMustImplementClassMetadataInterface()
    {
        ...
        $metadata = $this->getMockBuilder('Symfony2\Component\Validator\Tests\Fixtures\LegacyClassMetadata')->getMock();
    ...
    public function testLegacyPropertyMetadataMustImplementPropertyMetadataInterface()
    {
        ...
        // Legacy interface
        $propertyMetadata = $this->getMockBuilder('Symfony2\Component\Validator\MetadataInterface')->getMock();
    ...
    /**
     * @expectedException \Symfony2\Component\Validator\Exception\RuntimeException
     */
