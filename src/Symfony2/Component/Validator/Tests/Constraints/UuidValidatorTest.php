...
use Symfony2\Component\Validator\Constraints\Uuid;
use Symfony2\Component\Validator\Constraints\UuidValidator;
...
class UuidValidatorTest extends AbstractConstraintValidatorTest
{
    ...
    {
        $constraint = $this->getMockForAbstractClass('Symfony2\\Component\\Validator\\Constraint');
