...
use Symfony2\Component\Validator\Constraints\File;
use Symfony2\Component\Validator\Constraints\FileValidator;
...
abstract class FileValidatorTest extends AbstractConstraintValidatorTest
{
    ...
    {
        $file = $this
            ->getMockBuilder('Symfony2\Component\HttpFoundation\File\File')
    ...
    public function uploadedFileErrorProvider()
    {
        ...
        if (class_exists('Symfony2\Component\HttpFoundation\File\UploadedFile')) {
