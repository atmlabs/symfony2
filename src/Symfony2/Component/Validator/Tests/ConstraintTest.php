...
use Symfony2\Component\Validator\Tests\Fixtures\ClassConstraint;
use Symfony2\Component\Validator\Tests\Fixtures\ConstraintA;
use Symfony2\Component\Validator\Tests\Fixtures\ConstraintB;
use Symfony2\Component\Validator\Tests\Fixtures\ConstraintC;
use Symfony2\Component\Validator\Tests\Fixtures\ConstraintWithValue;
use Symfony2\Component\Validator\Tests\Fixtures\ConstraintWithValueAsDefault;
...
class ConstraintTest extends TestCase
{
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symfony2\Component\Validator\Exception\InvalidOptionsException');
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symfony2\Component\Validator\Exception\ConstraintDefinitionException');
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symfony2\Component\Validator\Exception\MissingOptionsException');
    ...
    /**
     * @expectedException \Symfony2\Component\Validator\Exception\InvalidArgumentException
     */
    ...
    /**
     * @expectedException \Symfony2\Component\Validator\Exception\InvalidOptionsException
