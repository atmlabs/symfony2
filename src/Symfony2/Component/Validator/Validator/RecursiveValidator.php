...
namespace Symfony2\Component\Validator\Validator;
...
use Symfony2\Component\Validator\ConstraintValidatorFactoryInterface;
use Symfony2\Component\Validator\Context\ExecutionContextFactoryInterface;
...
use Symfony2\Component\Validator\ObjectInitializerInterface;
...
class RecursiveValidator implements ValidatorInterface, LegacyValidatorInterface
{
    ...
    public function validate($value, $groups = null, $traverse = false, $deep = false)
    {
        ...
        if (self::testConstraints($groups) && ($numArgs < 3 || 3 === $numArgs && self::testGroups($traverse))) {
            ...
            @trigger_error('The Symfony2\Component\Validator\ValidatorInterface::validate method is deprecated in version 2.5 and will be removed in version 3.0. Use the Symfony2\Component\Validator\Validator\ValidatorInterface::validate method instead.', E_USER_DEPRECATED);
    ...
    {
        @trigger_error('The '.__METHOD__.' method is deprecated in version 2.5 and will be removed in version 3.0. Use the Symfony2\Component\Validator\Validator\ValidatorInterface::validate method instead.', E_USER_DEPRECATED);
    ...
    {
        @trigger_error('The '.__METHOD__.' method is deprecated in version 2.5 and will be removed in version 3.0. Use the Symfony2\Component\Validator\Validator\ValidatorInterface::getMetadataFor or Symfony2\Component\Validator\Validator\ValidatorInterface::hasMetadataFor method instead.', E_USER_DEPRECATED);
