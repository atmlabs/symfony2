...
@trigger_error('The class '.__NAMESPACE__.'\DefaultTranslator is deprecated since Symfony 2.7 and will be removed in 3.0. use Symfony2\Component\Translation\IdentityTranslator instead.', E_USER_DEPRECATED);
