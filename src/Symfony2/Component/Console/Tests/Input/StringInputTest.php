...
class StringInputTest extends TestCase
{
    ...
    public function testTokenize($input, $tokens, $message)
    {
        ...
        $r = new \ReflectionClass('Symfony2\Component\Console\Input\ArgvInput');
