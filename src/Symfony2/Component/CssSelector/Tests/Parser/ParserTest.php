...
namespace Symfony2\Component\CssSelector\Tests\Parser;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\CssSelector\Exception\SyntaxErrorException;
use Symfony2\Component\CssSelector\Node\FunctionNode;
use Symfony2\Component\CssSelector\Node\SelectorNode;
use Symfony2\Component\CssSelector\Parser\Parser;
...
class ParserTest extends TestCase
{
    ...
    public function testParseSeriesException($series)
    {
        ...
        /** @var FunctionNode $function */
        $function = $selectors[0]->getTree();
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symfony2\Component\CssSelector\Exception\SyntaxErrorException');
