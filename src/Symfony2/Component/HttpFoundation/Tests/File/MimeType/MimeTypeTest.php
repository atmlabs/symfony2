...
namespace Symfony2\Component\HttpFoundation\Tests\File\MimeType;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser;
use Symfony2\Component\HttpFoundation\File\MimeType\MimeTypeGuesser;
...
class MimeTypeTest extends TestCase
{
    ...
    public function testGuessWithNonReadablePath()
    {
        ...
        if ('0333' == substr(sprintf('%o', fileperms($path)), -4)) {
            $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symfony2\Component\HttpFoundation\File\Exception\AccessDeniedException');
