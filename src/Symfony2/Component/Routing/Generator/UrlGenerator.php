...
namespace Symfony2\Component\Routing\Generator;

use Psr\Log\LoggerInterface;
use Symfony2\Component\Routing\Exception\InvalidParameterException;
use Symfony2\Component\Routing\Exception\MissingMandatoryParametersException;
use Symfony2\Component\Routing\Exception\RouteNotFoundException;
...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected function doGenerate($variables, $defaults, $requirements, $tokens, $parameters, $name, $referenceType, $hostTokens, array $requiredSchemes = array())
    {
        ...
        // the contexts base URL is already encoded (see Symfony2\Component\HttpFoundation\Request)
