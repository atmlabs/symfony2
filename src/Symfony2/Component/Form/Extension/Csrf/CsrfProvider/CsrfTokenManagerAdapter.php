...
class CsrfTokenManagerAdapter implements CsrfProviderInterface
{
    ...
    public function getTokenManager($triggerDeprecationError = true)
    {
        if ($triggerDeprecationError) {
            @trigger_error('The '.__METHOD__.' method is deprecated since Symfony 2.4 and will be removed in version 3.0. Use the Symfony2\Component\Security\Csrf\CsrfTokenManager class instead.', E_USER_DEPRECATED);
        }
