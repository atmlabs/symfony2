...
@trigger_error('The '.__NAMESPACE__.'\SimpleChoiceList class is deprecated since Symfony 2.7 and will be removed in 3.0. use Symfony2\Component\Form\ChoiceList\ArrayChoiceList instead.', E_USER_DEPRECATED);
