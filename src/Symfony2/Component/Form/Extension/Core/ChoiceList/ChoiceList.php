...
@trigger_error('The '.__NAMESPACE__.'\ChoiceList class is deprecated since Symfony 2.7 and will be removed in 3.0. use Symfony2\Component\Form\ChoiceList\ArrayChoiceList instead.', E_USER_DEPRECATED);

use Symfony2\Component\Form\Exception\InvalidArgumentException;
use Symfony2\Component\Form\Exception\InvalidConfigurationException;
