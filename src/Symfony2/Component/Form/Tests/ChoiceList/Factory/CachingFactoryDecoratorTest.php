...
class CachingFactoryDecoratorTest extends TestCase
{
    ...
    {
        $loader1 = $this->getMockBuilder('Symfony2\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $loader2 = $this->getMockBuilder('Symfony2\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $list1 = new \stdClass();
        $list2 = new \stdClass();
