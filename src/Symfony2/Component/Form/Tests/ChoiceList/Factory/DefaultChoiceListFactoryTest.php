...
namespace Symfony2\Component\Form\Tests\ChoiceList\Factory;
...
use Symfony2\Component\Form\ChoiceList\LazyChoiceList;
...
use Symfony2\Component\Form\Extension\Core\View\ChoiceView as LegacyChoiceView;
...
class DefaultChoiceListFactoryTest extends TestCase
{
    ...
    public function testCreateViewForFlatLegacyChoiceList()
    {
        ...
        $list = $this->getMockBuilder('Symfony2\Component\Form\Extension\Core\ChoiceList\ChoiceListInterface')->getMock();
