...
use Symfony2\Component\Form\Test\FormInterface;
...
abstract class BaseValidatorExtensionTest extends TypeTestCase
{
    ...
    public function testValidationGroupsCanBeSetToGroupSequence()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Validator\Constraints\GroupSequence', $form->getConfig()->getOption('validation_groups'));
    }
