...
namespace Symfony2\Component\Form\Tests\Extension\DataCollector;

use PHPUnit\Framework\TestCase;
use Symfony2\Component\Form\CallbackTransformer;
use Symfony2\Component\Form\Exception\TransformationFailedException;
use Symfony2\Component\Form\Extension\DataCollector\FormDataExtractor;
...
class FormDataExtractorTest extends TestCase
{
    ...
    public function testExtractConfigurationBuildsIdRecursively()
    {
        ...
        $grandParent = $this->createBuilder('grandParent')
            ->setCompound(true)
            ->setDataMapper($this->getMockBuilder('Symfony2\Component\Form\DataMapperInterface')->getMock())
            ->getForm();
