...
namespace Symfony2\Component\Form\Tests\Extension\Csrf\Type;
...
use Symfony2\Component\Form\Test\TypeTestCase;
...
class FormTypeCsrfExtensionTest_ChildType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        // default
        $builder->add('name', 'Symfony2\Component\Form\Extension\Core\Type\TextType');
    }
}
...
class FormTypeCsrfExtensionTest extends TypeTestCase
{
    ...
    {
        $view = $this->factory
            ->create('Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
    ...
    {
        $view = $this->factory
            ->createNamedBuilder('root', 'Symfony2\Component\Form\Extension\Core\Type\FormType')
            ->add($this->factory
                ->createNamedBuilder('form', 'Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                    'csrf_field_name' => 'csrf',
                    'compound' => true,
                ))
            )
    ...
    public function testGenerateCsrfTokenUsesFormNameAsIntentionByDefault()
    {
        ...
        $view = $this->factory
            ->createNamed('FORM_NAME', 'Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                'csrf_field_name' => 'csrf',
                'csrf_token_manager' => $this->tokenManager,
                'compound' => true,
            ))
    ...
    public function testGenerateCsrfTokenUsesTypeClassAsIntentionIfEmptyFormName()
    {
        $this->tokenManager->expects($this->once())
            ->method('getToken')
            ->with('Symfony2\Component\Form\Extension\Core\Type\FormType')
            ->will($this->returnValue('token'));

        $view = $this->factory
            ->createNamed('', 'Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                'csrf_field_name' => 'csrf',
                'csrf_token_manager' => $this->tokenManager,
                'compound' => true,
            ))
    ...
    public function testValidateTokenOnSubmitIfRootAndCompound($valid)
    {
        ...
        $form = $this->factory
            ->createBuilder('Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                'csrf_field_name' => 'csrf',
                'csrf_token_manager' => $this->tokenManager,
                'csrf_token_id' => 'TOKEN_ID',
                'compound' => true,
    ...
    public function testValidateTokenOnSubmitIfRootAndCompoundUsesFormNameAsIntentionByDefault($valid)
    {
        ...
        $form = $this->factory
            ->createNamedBuilder('FORM_NAME', 'Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                'csrf_field_name' => 'csrf',
                'csrf_token_manager' => $this->tokenManager,
                'compound' => true,
            ))
    ...
    public function testValidateTokenOnSubmitIfRootAndCompoundUsesTypeClassAsIntentionIfEmptyFormName($valid)
    {
        $this->tokenManager->expects($this->once())
            ->method('isTokenValid')
            ->with(new CsrfToken('Symfony2\Component\Form\Extension\Core\Type\FormType', 'token'))
            ->will($this->returnValue($valid));

        $form = $this->factory
            ->createNamedBuilder('', 'Symfony2\Component\Form\Extension\Core\Type\FormType', null, array(
                'csrf_field_name' => 'csrf',
                'csrf_token_manager' => $this->tokenManager,
                'compound' => true,
            ))
    ...
    public function testNoCsrfProtectionOnPrototype()
    {
        $prototypeView = $this->factory
            ->create('Symfony2\Component\Form\Extension\Core\Type\CollectionType', null, array(
