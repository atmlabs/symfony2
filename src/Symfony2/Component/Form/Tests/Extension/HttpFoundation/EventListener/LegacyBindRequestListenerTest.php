...
namespace Symfony2\Component\Form\Tests\Extension\HttpFoundation\EventListener;
...
class LegacyBindRequestListenerTest extends TestCase
{
    ...
    public function testSubmitEmptyRequestToCompoundForm($method)
    {
        ...
        $config->setDataMapper($this->getMockBuilder('Symfony2\Component\Form\DataMapperInterface')->getMock());
        $form = new Form($config);
        $event = new FormEvent($form, $request);
