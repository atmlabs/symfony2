...
use Symfony2\Component\HttpKernel\DataCollector\DumpDataCollector;
...
class DumpDataCollectorTest extends TestCase
{
    public function testDump()
    {
        ...
        $this->assertStringMatchesFormat('a:3:{i:0;a:5:{s:4:"data";O:39:"Symfony2\Component\VarDumper\Cloner\Data":%a', $collector->serialize());
