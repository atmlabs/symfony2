...
namespace Symfony2\Component\HttpKernel\Tests\Fragment;
...
use Symfony2\Component\HttpKernel\Fragment\InlineFragmentRenderer;
...
class InlineFragmentRendererTest extends TestCase
{
    ...
    {
        $resolver = $this->getMockBuilder('Symfony2\\Component\\HttpKernel\\Controller\\ControllerResolver')->setMethods(array('getController'))->getMock();
        $resolver
            ->expects($this->once())
