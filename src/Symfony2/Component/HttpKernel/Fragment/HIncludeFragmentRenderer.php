...
namespace Symfony2\Component\HttpKernel\Fragment;

use Symfony2\Component\HttpFoundation\Request;
use Symfony2\Component\HttpFoundation\Response;
use Symfony2\Component\HttpKernel\Controller\ControllerReference;
use Symfony2\Component\HttpKernel\UriSigner;
use Symfony2\Component\Templating\EngineInterface;
...
class HIncludeFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    public function setTemplating($templating)
    {
        if (null !== $templating && !$templating instanceof EngineInterface && !$templating instanceof Environment) {
            throw new \InvalidArgumentException('The hinclude rendering strategy needs an instance of Twig\Environment or Symfony2\Component\Templating\EngineInterface');
        }
