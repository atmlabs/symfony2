...
namespace Symfony2\Component\BrowserKit;

use Symfony2\Component\DomCrawler\Crawler;
use Symfony2\Component\DomCrawler\Form;
use Symfony2\Component\DomCrawler\Link;
...
abstract class Client
{
    ...
    {
        if ($insulated && !class_exists('Symfony2\\Component\\Process\\Process')) {
    ...
    {
        if (!class_exists('Symfony2\Component\DomCrawler\Crawler')) {
            return;
        }
