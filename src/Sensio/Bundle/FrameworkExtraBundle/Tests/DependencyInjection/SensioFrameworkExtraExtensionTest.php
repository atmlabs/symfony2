...
class SensioFrameworkExtraExtensionTest extends \PHPUnit_Framework_TestCase
{
    public function testLegacySecurityListener()
    {
        ...
        $r = new \ReflectionClass('Symfony2\Bundle\SecurityBundle\SecurityBundle');
        ...
        $this->assertInstanceOf('Symfony2\Component\DependencyInjection\Reference', $securityContext);
    }
