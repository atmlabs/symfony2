...
class AnnotatedRouteControllerLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $route = $this->getMockBuilder('Symfony2\Component\Routing\Route')
    ...
    public function testLoad()
    {
        ...
        $this->assertInstanceOf('Symfony2\Component\Routing\RouteCollection', $rc);
        $this->assertCount(2, $rc);

        $this->assertInstanceOf('Symfony2\Component\Routing\Route', $rc->get('index'));
        ...
        $this->assertInstanceOf('Symfony2\Component\Routing\Route', $rc->get('new'));
