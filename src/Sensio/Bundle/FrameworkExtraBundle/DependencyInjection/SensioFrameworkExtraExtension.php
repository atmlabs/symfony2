...
class SensioFrameworkExtraExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if ($config['security']['annotations']) {
            ...
            if (class_exists('Symfony2\Component\ExpressionLanguage\ExpressionLanguage') && class_exists('Symfony2\Component\Security\Core\Authorization\ExpressionLanguage')) {
